...
<template>
  <div :class="{'custom-dropdown': true, 'custom-dropdown--clicked': isClicked}">
    <button class="custom-dropdown__field custom-dropdown__field--main" type="button" @click="showVariants">
      <span 
        class="custom-dropdown__chosen-text"
        >{{ currentValue }} г.</span>
    ...
    <ul class="custom-dropdown__list" >
      <li 
        ...
        v-for="weight in weightVariants"
      >
        <button 
          class="custom-dropdown__field" 
          type="button" 
          @click="setValue(weight)">{{ weight }} г.</button>
      </li>
    </ul>
  </div>
</template>
