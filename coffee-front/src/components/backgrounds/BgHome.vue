...
<template>
  ...
  <template v-else-if="section == 'instagram'">
    ...
    <div class="background__div background__div--instagram-top-wall"></div>
        ...
        <svg class="background__svg-vawe background__svg-vawe--instagram" width="3720" height="664" aria-hidden="true">
          <use xlink:href="../../assets/bg-sprite.svg#bg-instagram-ellipse"></use>
        </svg>

        <svg class="background__svg-vawe-for-tablet background__svg-vawe--instagram" width="2627" height="288" aria-hidden="true">
          <use xlink:href="../../assets/bg-sprite.svg#bg-instagram-ellipse-for-tablet"></use>
        </svg>
        ...
        <svg class="background__svg-vawe-for-tablet background__svg-vawe--instagram-bottom" width="2627" height="288" aria-hidden="true">
          <use xlink:href="../../assets/bg-sprite.svg#bg-instagram-bottom-vawe-for-tablet"></use>
        </svg>
