...
<template>
  ...
  <template v-else-if="route.name == 'contacts'">
    ...
    <svg class="background__svg-vawe background__svg-vawe--contacts-front-footer"
    width="3720" height="407" aria-hidden="true">
      <use xlink:href="../../assets/bg-sprite.svg#bg-catalog-front-for-footer"></use>
    </svg>

    <svg class="background__svg-vawe-for-tablet background__svg-vawe--contacts-front-footer"
    width="1348" height="190" aria-hidden="true">
    ...
    <svg class="background__svg-vawe background__svg-vawe--catalog-front-footer"
    width="3720" height="407" aria-hidden="true">
      <use xlink:href="../../assets/bg-sprite.svg#bg-catalog-front-for-footer"></use>
    </svg>

    <svg class="background__svg-vawe-for-tablet background__svg-vawe--catalog-front-footer"
    width="1348" height="190" aria-hidden="true">
      <use xlink:href="../../assets/bg-sprite.svg#bg-catalog-front-for-footer-for-tablet"></use>
    </svg>
