...
<template>
  <div
    :class="{
      'product-card': true,
      'product-card--sale': props.product.actions['Скидки'],
      'product-card--main-mobile': isHomePage,
    }"
  >
    ...
    <div class="product-card__top">
      <div class="product-card__actions">
        <ul class="product-card__actions-list">
          <li
            v-if="props.product.actions['Скидки']"
            v-for="action in Object.entries(product.actions)
              .filter((el) => el[1])
              .map((el) => el[0])"
    ...
    <div class="product-card__bottom">
      <span class="product-card__price product-card__price--crossed"
