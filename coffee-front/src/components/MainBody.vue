...
<template>
  <main>
    <section class="overview">
      ...
      >
        <use
          xlink:href="@/images/background/bg-sprite.svg#bg-puddle-right"
        ></use>
      </svg>
      ...
      >
        <use
          xlink:href="../images/background/bg-sprite.svg#bg-puddle-left"
        ></use>
      </svg>
      <svg
      ...
      >
        <use
          xlink:href="../images/background/bg-sprite.svg#bg-puddle-left-for-laptop"
        ></use>
      </svg>
      ...
      >
        <use
          xlink:href="../images/background/bg-sprite.svg#bg-overview-vawe"
        ></use>
      </svg>
      ...
      >
        <use
          xlink:href="../images/background/bg-sprite.svg#bg-overview-vawe-for-tablet"
        ></use>
      </svg>
          ...
          <div class="overview__products-cards">
            ...
            <ul class="overview__products-list">
              <li class="overview__products-item">
                <div
                  class="product-card product-card--sale product-card--main-mobile"
                >
                  ...
                  <div class="product-card__top">
                    <div class="product-card__categories">
                      <ul class="product-card__category-list">
                        ...
                        <li class="product-card__category-item">
                          Новый урожай
                        </li>
                    ...
                    <div class="custom-dropdown product-card__dropdown">
                      ...
                      >
                        ...
                        >
                          <use
                            xlink:href="./images/product-card/product-sprite.svg#icon-down-arrow"
                          ></use>
                        </svg>
                      </button>
                      <ul class="custom-dropdown__list">
                        <li class="custom-dropdown__item">
                          <button class="custom-dropdown__field" type="button">
                            250 г.
                          </button>
                        </li>
                        <li class="custom-dropdown__item">
                  ...
                  <div class="product-card__middle">
                    <div class="product-card__image-wrapper">
                      <picture>
                        <source
                          media="(max-width: 767px)"
                          srcset="
                            ../images/product-card/product-image-mobile.png
                          "
                        />
                        <source
                          media="(max-width: 1348px)"
                          srcset="
                            ../images/product-card/product-image-tablet.png
                          "
                        />
                        <source
                          media="(max-width: 1903px)"
                          srcset="
                            ../images/product-card/product-image-laptop.png
                          "
                        />
                        <img
                    ...
                    <div class="product-card__details">
                      <ul class="product-card__stars slider-stars">
                        <li
                          class="slider-stars__item slider-stars__item--selected"
                        >
                          <svg
                            class="slider-stars__svg"
                            width="25"
                            height="25"
                            aria-hidden="true"
                          >
                            <use
                              xlink:href="../images/product-card/product-sprite.svg#icon-star"
                            ></use>
                          </svg>
                        </li>
                      ...
                      <ul class="product-card__corns slider-corns">
                        <li class="slider-corns__item">
                          ...
                          >
                            <use
                              xlink:href="../images/product-card/product-sprite.svg#icon-corn"
                            ></use>
                          </svg>
                        </li>
                        <li class="slider-corns__item">
                      ...
                      <div class="product-card__hue">
                        ...
                        <ul class="slider-points">
                          <li
                            class="slider-points__item slider-points__item--selected"
                          ></li>
                          <li
                            class="slider-points__item slider-points__item--selected"
                          ></li>
                  ...
                  <p class="product-card__description">
                    Свежеобжаренный кофе&nbsp;&mdash; описание товара, вкус,
                    аромат
                  </p>
                  <div class="product-card__bottom">
                    ...
                    <button class="product-card__button btn btn--size-s">
                      В&nbsp;корзину
                    </button>
                  </div>
                </div>
            ...
            >
              ...
              >
                <use
                  xlink:href="./images/btn/btn-sprite.svg#arrow-forward"
                ></use>
              </svg>
            </button>
          </div>
    ...
    <section class="advantages">
      ...
      >
        <use
          xlink:href="../../images/background/bg-sprite.svg#bg-advantages-vawe"
        ></use>
      </svg>
      ...
      >
        <use
          xlink:href="../../images/background/bg-sprite.svg#bg-advantages-vawe-for-tablet"
        ></use>
      </svg>
            ...
            <ul class="advantages__list">
              <li class="advantages__item">
                <div class="advantages__item-icon">
                  ...
                  >
                    <use
                      xlink:href="./images/advantages/advantages-sprite.svg#icon-cup"
                    ></use>
                  </svg>
                </div>
              ...
              <li class="advantages__item">
                <div class="advantages__item-icon">
                  ...
                  >
                    <use
                      xlink:href="./images/advantages/advantages-sprite.svg#icon-mark"
                    ></use>
                  </svg>
                </div>
                <div class="advantages__item-text">
              ...
              <li class="advantages__item">
                <div class="advantages__item-icon">
                  ...
                  >
                    <use
                      xlink:href="./images/advantages/advantages-sprite.svg#icon-consult"
                    ></use>
                  </svg>
                </div>
                <div class="advantages__item-text">
    ...
    <section class="technology">
      ...
      >
        <use
          xlink:href="../../images/background/bg-sprite.svg#bg-technology-first-vawe"
        ></use>
      </svg>
      ...
      >
        <use
          xlink:href="../../images/background/bg-sprite.svg#bg-technology-first-vawe-for-tablet"
        ></use>
      </svg>
      ...
      >
        <use
          xlink:href="../../images/background/bg-sprite.svg#bg-technology-second-vawe"
        ></use>
      </svg>
      ...
      >
        <use
          xlink:href="../../images/background/bg-sprite.svg#bg-technology-second-vawe-for-tablet"
        ></use>
      </svg>
    ...
    <section class="news">
      ...
      >
        <use
          xlink:href="../../images/background/bg-sprite.svg#bg-news-vawe"
        ></use>
      </svg>
      ...
      <div class="container">
        ...
        <div class="news__arrows">
          ...
          >
            ...
            >
              <use
                xlink:href="../../images/news/news-sprite.svg#icon-news-prev"
              ></use>
            </svg>
          </button>
          ...
          >
            ...
            >
              <use
                xlink:href="../../images/news/news-sprite.svg#icon-news-next"
              ></use>
            </svg>
          </button>
        </div>
            ...
            <div class="news-card news-card--flat">
              ...
              <div class="news-card__inner">
                ...
                <a class="news-card__link btn-linked" href="#">
                  ...
                  >
                    <use
                      xlink:href="./images/btn/btn-sprite.svg#arrow-for-link"
                    ></use>
                  </svg>
                </a>
              </div>
    ...
    <section class="instagram">
      ...
      >
        <use
          xlink:href="../../images/background/bg-sprite.svg#bg-instagram-ellipse"
        ></use>
      </svg>
      ...
      >
        <use
          xlink:href="../../images/background/bg-sprite.svg#bg-instagram-ellipse-for-tablet"
        ></use>
      </svg>
      ...
      >
        <use
          xlink:href="../../images/background/bg-sprite.svg#bg-instagram-bottom-vawe-for-tablet"
        ></use>
      </svg>
      ...
      <div class="container">
        <div class="instagram__title-wrapper">
          ...
          >
            ...
            >
              <use
                xlink:href="./images/instagram/instagram-sprite.svg#icon-instagram"
              ></use>
            </svg>
          </a>
        </div>
